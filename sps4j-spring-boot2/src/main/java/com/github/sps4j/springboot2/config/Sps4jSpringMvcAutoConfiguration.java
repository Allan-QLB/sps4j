package com.github.sps4j.springboot2.config;

import com.github.sps4j.springboot2.web.Sps4jTomcatWebServerFactory;
...
@ConditionalOnExpression("T(java.lang.Thread).currentThread().contextClassLoader instanceof T(com.github.sps4j.core.load.Sps4jPluginClassLoader)")
